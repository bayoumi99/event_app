...
class EditEven extends StatefulWidget {
  ...
  static const String routeName = "Edit Event Screen ";

  @override
  State<EditEven> createState() => _EditEvenState();
}

class _EditEvenState extends State<EditEven> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title:  Text("Edit Event",textAlign: TextAlign.center,),
      ),
      body: ListView(
